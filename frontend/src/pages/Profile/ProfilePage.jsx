...
const ProfilePage = () => {
  ...
  return (
    <div className="bg-white border border-slate-200 shadow-sm overflow-hidden max-w-4xl mx-auto">
      ...
      <form onSubmit={handleUpdateProfile}>
        <div className="p-6 space-y-6">
          ...
          <div className="pt-6 border-t border-slate-200">
            <h4 className="text-lg font-medium text-slate-900">Buisness Information</h4>
        ...
        <div className="px-6 py-4 bg-slate-50 border-t border-slate-200 flex justify-end">
          <button type="submit" disabled={isUpdating} className="inline-flex items-center justify-center px-4 py-2 h-10 bg-blue-900 hover:bg-blue-800 text-white font-medium text-sm rounded-lg transition-colors duration-200 focus:outline-none focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed ">
