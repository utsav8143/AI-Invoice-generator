...
const AllInvoices = () => {
  ...
  if (loading) {
    return (
      <div className="flex justify-center inset-shadow-teal-800 h-8  text-blue-600 ">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-semibold text-shadow-slate-900">
            All Invoices
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="relative grow">
              ...
              <input
                ...
                className="w-full h-10 pl-10 pr-4 py-2 border border-slate-200 rounded-lg bg-white text-slate-900  focus:outline-none focus:ring-2 focus:ring-blue-500"
                value={searchTerm}
        ...
        {filteredInvoices.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-slate-500 mb-6 max-w-md">
              Your search to filter criteria did not match any invoices. Try
