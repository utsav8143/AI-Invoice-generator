      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-4 md:col-span-2 lg:col-span-1">
            ...
            <p className="text-gray-400 leading-relaxed max-w-sm">The simplest way to create and send professional invoices.</p>
          </div>
          <div>
        ...
        <div className="border-t border-gray-800 py-8 mt-16">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400">&copy;2026 AI Invoice App.All rights reserved</p>
            <div className="flex space-x-4 ">
              <SocialLinks href="#"><FaTwitter className="w-5 h-5" /></SocialLinks>
              <SocialLinks href="#"><FaGithub className="w-5 h-5" /></SocialLinks>
              <SocialLinks href="#"><FaLinkedin className="w-5 h-5" /></SocialLinks>
            </div>
          </div>
        </div>
      </div>
