        ...
        <div className="bg-white rounded-lg shadow-xl max-w-lg w-full p-6 relative text-left transform transition-all">
          ...
          <div className="space-y-4">
            <p className="text-sm text-slate-600 ">
              Paste any text that contains details (like client name, items,
              quantities, and prices) and that AI can attempt to create an
              invoice from it.
             </p>
             <Textarea
              name="invoicetext"
              ...
              placeholder="e.g., 'Invoice for ClientCorp :2 hours of design work at 150₹/hr'"
              rows={8}
             />
         </div>
          ...
          <div className="flex justify-end space-x-3 mt-6">
            ...
            <Button onClick={handleGenerate} isLoading={isLoading}>
              {isLoading ? "Generating..." : "Genearte Invoice"}
            </Button>
          </div>
        </div>
      </div>
